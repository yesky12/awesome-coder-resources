...
//
> 【list】----------Markdown editing with Visual Studio Code
...
//
> ----------Java IDE Pack - Visual Studio Marketplace
> https://marketplace.visualstudio.com/items?itemName=pverest.java-ide-pack
在VS Code中追求最好的Java工具。

截至2018年2月，VS Code已经不仅仅是编辑。对于Java，它具有调试，JUnit支持。developmnet由（开发商）公司领导：Red Hat，Microsoft，Pivotal。并且有许多不同的扩展可用于其他语言和一般性质。

这个扩展包用于帮助引导VS Code for Java开发。通过GitHub上的问题进行评论，但请注意，功能贡献是通过下面列出的特定扩展来完成的，您应该使用相应的资源来学习和提供（问题，更改）。所有GitHub链接如下。

包括
列为displayName，publisher。name（又名唯一标识符），GitHub URL [，“description”，notes]：

Java语言支持redhat.java
https://github.com/redhat-developer/ vscode -java
Maven项目资源管理器https://github.com/Microsoft/ vscode -mavenvscjava.vscode-maven
调试器的Java https://github.com/Microsoft/ vscode -java调试vscjava.vscode-java-debug
Java的测试运行https://github.com/Microsoft/ vscode -java测试vscjava.vscode-java-test
春天Initializr Java支持https://github.com/Microsoft/ vscode -Spring-initializrvscjava.vscode-spring-initializr
“春引导仪表板” https://github.com/Microsoft/ vscode -Spring启动，仪表盘vscjava.vscode-spring-boot-dashboard
春季启动工具https://github.com/spring-projects/sts4/tree/master/ vscode -ExtensionsPivotal.vscode-spring-boot
Java属性ithildir.java-properties
https://github.com/ithildir/vscode -java -properties “ .propertiesVisual Studio代码突出显示的TextMate Java Properties（）语法的一个端口。”
的Java反编译dgileadi.java-decompiler
https://github.com/dgileadi/ vscode -java，反编译
vscode -icons https://github.com/ vscode -icons / vscode -iconsrobertohuertasm.vscode-icons
Tomcat的对Java https://github.com/adashen/ vscode -Tomcatadashen.vscode-tomcat
“Java IDE的” extention 
https://github.com/jiangdequan/ vscode -java，马刀


//
> ----------Java IDE - Visual Studio Marketplace
...
此扩展程序有助于自动创建代码段。选择要创建片段的文本，然后从命令面板中使用命令“创建片段”。



//
> ----------Calva: Clojure & Clojurescript interactive programming made easy - Visual Studio Marketplace
...
//
> ----------API Elements扩展 - Visual Studio Marketplace
> https://marketplace.visualstudio.com/items?itemName=vncz.vscode-apielements
欢迎使用Visual Studio Code的API Elements扩展！这是一个完全未经测试的扩展，它将改善您使用API​​描述格式（如API **Blueprint和Swagger**）的体验。它提供了一些很棒的功能，例如：
